...
// 	protoc        v3.11.4
// source: basicpb/serverstream-api.proto
...
func (x *NotificationMessage) Reset() {
	*x = NotificationMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_basicpb_serverstream_api_proto_msgTypes[0]
...
func (*NotificationMessage) Descriptor() ([]byte, []int) {
	return file_basicpb_serverstream_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *NotificationMessageRequest) Reset() {
	*x = NotificationMessageRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_basicpb_serverstream_api_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotificationMessageRequest) Descriptor() ([]byte, []int) {
	return file_basicpb_serverstream_api_proto_rawDescGZIP(), []int{1}
}
...
func (x *NotificationMessageResponse) Reset() {
	*x = NotificationMessageResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_basicpb_serverstream_api_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotificationMessageResponse) Descriptor() ([]byte, []int) {
	return file_basicpb_serverstream_api_proto_rawDescGZIP(), []int{2}
}
...
var File_basicpb_serverstream_api_proto protoreflect.FileDescriptor

var file_basicpb_serverstream_api_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x62, 0x61, 0x73, 0x69, 0x63, 0x70, 0x62, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2d, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x07, 0x62, 0x61, 0x73, 0x69, 0x63, 0x70, 0x62, 0x22, 0x47, 0x0a, 0x13, 0x4e, 0x6f, 0x74,
	...
	0x67, 0x65, 0x22, 0x56, 0x0a, 0x1a, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	...
	0x0a, 0x08, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x61, 0x22, 0x85, 0x01, 0x0a, 0x1b, 0x4e,
	...
	,
}

var (
	file_basicpb_serverstream_api_proto_rawDescOnce sync.Once
	file_basicpb_serverstream_api_proto_rawDescData = file_basicpb_serverstream_api_proto_rawDesc
)

func file_basicpb_serverstream_api_proto_rawDescGZIP() []byte {
	file_basicpb_serverstream_api_proto_rawDescOnce.Do(func() {
		file_basicpb_serverstream_api_proto_rawDescData = protoimpl.X.CompressGZIP(file_basicpb_serverstream_api_proto_rawDescData)
	})
	return file_basicpb_serverstream_api_proto_rawDescData
}

var file_basicpb_serverstream_api_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_basicpb_serverstream_api_proto_goTypes = []interface{}{
	(*NotificationMessage)(nil),         // 0: basicpb.NotificationMessage
	(*NotificationMessageRequest)(nil),  // 1: basicpb.NotificationMessageRequest
	(*NotificationMessageResponse)(nil), // 2: basicpb.NotificationMessageResponse
}
var file_basicpb_serverstream_api_proto_depIdxs = []int32{
	0, // 0: basicpb.NotificationMessageResponse.responsePayload:type_name -> basicpb.NotificationMessage
	1, // 1: basicpb.NotificationMessageService.NotificationMessage:input_type -> basicpb.NotificationMessageRequest
	2, // 2: basicpb.NotificationMessageService.NotificationMessage:output_type -> basicpb.NotificationMessageResponse
...
func init() { file_basicpb_serverstream_api_proto_init() }
func file_basicpb_serverstream_api_proto_init() {
	if File_basicpb_serverstream_api_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_basicpb_serverstream_api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_basicpb_serverstream_api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_basicpb_serverstream_api_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_basicpb_serverstream_api_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_basicpb_serverstream_api_proto_goTypes,
		DependencyIndexes: file_basicpb_serverstream_api_proto_depIdxs,
		MessageInfos:      file_basicpb_serverstream_api_proto_msgTypes,
	}.Build()
	File_basicpb_serverstream_api_proto = out.File
	file_basicpb_serverstream_api_proto_rawDesc = nil
	file_basicpb_serverstream_api_proto_goTypes = nil
	file_basicpb_serverstream_api_proto_depIdxs = nil
}
...
func (c *notificationMessageServiceClient) NotificationMessage(ctx context.Context, in *NotificationMessageRequest, opts ...grpc.CallOption) (NotificationMessageService_NotificationMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NotificationMessageService_serviceDesc.Streams[0], "/basicpb.NotificationMessageService/NotificationMessage", opts...)
	if err != nil {
		return nil, err
	}
...
var _NotificationMessageService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "basicpb.NotificationMessageService",
	...
	Metadata: "basicpb/serverstream-api.proto",
}
